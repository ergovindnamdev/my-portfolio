          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:border-cyan-400/30 transition-all duration-300">
              <p className="text-gray-200 text-lg leading-relaxed">
                ...
                with a passion for building cutting-edge solutions. I specialize
                in creating scalable web applications and integrating artificial
                intelligence to solve complex business problems.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 backdrop-blur-sm border border-cyan-400/30 rounded-xl p-6 hover:border-cyan-400/50 transition-all duration-300">
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                ...
                . With{" "}
                <span className="text-cyan-400 font-semibold">
                  15+ years of fullstack experience
                </span>{" "}
                ({" "}
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:border-cyan-400/30 transition-all duration-300">
              <p className="text-gray-200 text-lg leading-relaxed">
                ...
                and web development, building applications that leverage{" "}
                ...
                . My commitment to staying at the forefront of technology drives
                me to continuously explore emerging AI tools and frameworks.
              </p>
            </div>
