...
export default function GetInTouch() {
  return (
    <div
      ...
      data-aos="fade-up"
      className="flex flex-col space-y-4 w-full h-96 items-center bg-AAprimary bg-[url('/Bg-Grid.png')]"
    >
      {/* // ? Title === > What's Next?  */}
      ...
      I&apos;m always open to new opportunities and my inbox is always welcoming. Whether you have a question or simply want to say hello, I’ll do my utmost to respond promptly!
      </p>
      <div className="pt-4">
