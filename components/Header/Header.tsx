  ...
  return (
    <>
      ...
      <motion.div
        ...
        transition={{ opacity: { delay: props.finishedLoading ? 0 : 1, duration: 0 } }}
        className={`w-full fixed ${ShowElement ? `bg-opacity-95 shadow-xl backdrop-blur-md` : `bg-opacity-0 `} bg-AAprimary flex 
      justify-between px-6 sm:px-12 py-3 sm:py-5  transition duration-300 translate-y-0 z-30`}
      >
        {/* Logo A */}
